...
const profileReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case profileActionTypes.CREATE_FLAT_RATE_START: {
            return {
                ...state,
                creatingFlatRate: true,
                createFlatRateError: null,
            }
        }
        case profileActionTypes.CREATE_FLAT_RATE_SUCCESS: {
            const newRates = [...state.flatRates, action.payload]
            return {
                ...state,
                flatRates: newRates,
                creatingFlatRate: false,
                createFlatRateError: null,
            }
        }
        case profileActionTypes.CREATE_FLAT_RATE_FAILURE: {
            return {
                ...state,
                creatingFlatRate: false,
                createFlatRateError: action.payload,
            }
        }
